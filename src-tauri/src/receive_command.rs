...
#[tauri::command]
pub async fn fetch_tag_list(gateway_mac: String, index: usize, size: usize, tag_mac: String, ) -> crate::Result<PageResponse<Arc<Mutex<TagDto>>>> {
...
#[tauri::command]
pub async fn fetch_gateway(index: usize, size: usize,mac: String, ) -> crate::Result<PageResponse<Arc<Mutex<Gateway>>>> {
